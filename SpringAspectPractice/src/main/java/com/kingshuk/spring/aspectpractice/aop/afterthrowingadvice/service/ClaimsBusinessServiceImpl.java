...
import com.kingshuk.spring.aspectpractice.aop.afterthrowingadvice.utility.ApplicationUtil;
...
public class ClaimsBusinessServiceImpl implements ClaimsBusinessService {
    ...
    public void addANewInsured(Insured insured) {
        try {
            ...
            throw new RuntimeException("Something went wrong while adding a new insured");
