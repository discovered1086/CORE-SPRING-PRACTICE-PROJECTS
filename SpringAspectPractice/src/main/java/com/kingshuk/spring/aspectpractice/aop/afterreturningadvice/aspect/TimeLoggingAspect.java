...
public class TimeLoggingAspect {
    ...
    @Before("com.kingshuk.spring.aop.afterreturningadvice.aspect.CommonPointcutsForAfterReturning.forAllClaims()")
    ...
    @AfterReturning("com.kingshuk.spring.aop.afterreturningadvice.aspect.CommonPointcutsForAfterReturning.forAllClaims()")
