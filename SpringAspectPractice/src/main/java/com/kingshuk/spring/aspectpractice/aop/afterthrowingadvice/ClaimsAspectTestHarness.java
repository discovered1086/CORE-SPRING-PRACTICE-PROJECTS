package com.kingshuk.spring.aspectpractice.aop.afterthrowingadvice;
...
import com.kingshuk.spring.aspectpractice.config.AOPConfigForAfterThrowingAdvice;
...
public class ClaimsAspectTestHarness {
    ...
    public static void main(String[] args) {
        ...
        AnnotationConfigApplicationContext annotationConfigApplicationContext =
                new AnnotationConfigApplicationContext(AOPConfigForAfterThrowingAdvice.class);
